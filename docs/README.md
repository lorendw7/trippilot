...
The canonical documents below are bilingual. Language-specific landing pages provide a comfortable entry point without duplicating the detailed content.

以下核心文档均为中英双语。语言入口页只负责导航，避免重复维护详细内容。
...
- [Architecture decisions / 架构决策记录](decisions/README.md)
